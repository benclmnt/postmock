...
The live tests read `Id` and `TotalMessages` from the POST answer: `sdk/postmark.js/test/integration/Sending.test.ts:48-49`; `sdk/postmark-dotnet/src/Postmark.Tests/ClientBulkSendingTests.cs:51-54` **SDK**.
